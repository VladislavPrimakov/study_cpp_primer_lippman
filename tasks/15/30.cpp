//Упражнение 15.30.Напишите собственную версию класса Basket и
//используйте ее для вычисления цены за те же транзакции, что и в
...
int main() {
	Basket basket;
	basket.add_item(Bulk_quote("12345", 50.0, 10, 0.2));
	basket.add_item(Bulk_quote("67890", 30.0, 15, 0.1));
	basket.add_item(Limit_quote("54321", 20.0, 10, 0.25));
	size_t quantity = 12;
